...
fun createKeystoreForCordaNode(sslKeyStorePath: Path,
    ...
    val clientCACert = X509Utilities.createCertificate(CertificateType.INTERMEDIATE_CA,
            ...
            // TODO This is wrong! The X500 name on the node CA *is* the node legal name. Fixing this however breaks
            // IdentityService.verifyAndRegisterIdentity since it uses the X500 name to figure out the top-most identity
            // cert. verifyAndRegisterIdentity must first be fixed to use some other identifier for the node CA, perhaps
            // some flag.
            legalName.copy(commonName = "TODO Do not overrwite CN!"),
            clientKey.public,
