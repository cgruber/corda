...
class PersistentIdentityService(override val trustRoot: X509Certificate,
    ...
    override fun verifyAndRegisterIdentity(identity: PartyAndCertificate): PartyAndCertificate? {
        ...
        // the doorman then the logic below won't work. We need a correct way of identifying the node CA cert, perhaps with
        // a flag. This same issue applies to InMemoryIdentityService
